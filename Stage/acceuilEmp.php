...
<html>
    ...
    <span id="spC" class="glyphicon glyphicon-comment"></span>
      <button type="submit" name="quitter">      <span  id="sp1" class="glyphicon glyphicon-off"></span></button>  </form>  </div>
       ...
       <p>       <a href="emploi.php">    <span class="glyphicon glyphicon-time"></span>modifier des horaires  </a></p>
       <p>       <a href="payerEt.php"> <span class="glyphicon glyphicon-credit-card"></span>facturer  un etudiant </a></p>
       <p>        <a href="prof.php"><span class="glyphicon glyphicon-user"></span> Ajouter un prof </a> </p>
       <p> <a href="grille.php"> <span class="glyphicon glyphicon-stats"></span>Modifier une  Grille de cheminement</a></p>
       <p> <span class="glyphicon glyphicon-save-file"></span>Créer un  Sondage et votes </p>
       <p> <a href="messagerie.php">         <span class="glyphicon glyphicon-paste"></span>Partager documents et messages</a> </p>
       <p> <a href="personal.php">        <span class="glyphicon glyphicon-briefcase"></span>inscrire un etudiant </a></p> 
